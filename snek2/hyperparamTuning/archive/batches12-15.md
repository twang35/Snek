# Completed runs — archived narratives, batches 12-15

Per-batch write-ups retired from [`../completedRuns.md`](../completedRuns.md) on **2026-08-12**, when
batch 20's nine-shape sweep closed and the live file had grown past 1,700 lines. **History only — do not
read into context during normal work.**

**The canonical arm table did not move.** Every arm from these batches still has its row in
[`../completedRuns.md`](../completedRuns.md), with config, best checkpoint and verdict; what is here is
the long-form narrative behind those rows. Batches 1-11 are in
[`batches1-11.md`](batches1-11.md); batch 16 onward is still live.

| batch | change | verdict |
|---|---|---|
| 15 | `N_STEP_UPDATE=3` | falsified on speed — 128k slower, 3/4 seeds; evals null. A 97/100 that re-measures at 93.0% |
| 14 | `DISCOUNT=0.9975` at `GUIDED_FRACTION=0.8` | null vs 13 on every metric surviving the gate; the widest seed spread recorded to that point |
| 13 | epsilon handover 0.0125 + exploration shield 0.5 | an exact null vs 11 on five metrics — but it is what made the rewritten ladder survivable |
| 12 | epsilon handover 0.05 | **deadlocked, abandoned 4/4 at ~1M** — the failure that produced the shield |
...
[`charts.md`](charts-archive.md#batch-15--n_step_update3-falsified-on-speed-and-the-longest-arms-on-record).
...
[`archive/charts-archive.md`](charts-archive.md#batch-14--discount09975-at-guided_fraction08-and-a-third-null).
...
[`archive/charts-archive.md`](charts-archive.md#batch-13--the-lower-handover-plus-the-shield-and-an-exact-null)
...
[`charts.md`](charts-archive.md#batch-12--the-epsilon-rewrite-and-the-deadlock-it-found).
