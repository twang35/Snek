...
## C51 pilot — distributional RL, learning-rate screen — *eight arms running on the laptop*

**A seventh section on purpose, and temporary.** The cap of six counts numbered batches; this is a 600k
screen that becomes a batch when it closes, and retiring `b23` for something that will be replaced within
the day would cost the link repair twice. It goes back to six at the next batch close.
...
**c51pilot-lr1e5seed1** — lr 1e-05, best-30 13.0, first perfect 141k

![c51pilotB-lr1e4seed1](charts/c51pilotB-lr1e4seed1.png)
**c51pilotB-lr1e4seed1** — lr 0.0001, best-30 0.0, first perfect 8k, **stopped short**

![c51pilotB-lr1e4seed2](charts/c51pilotB-lr1e4seed2.png)
**c51pilotB-lr1e4seed2** — lr 0.0001, best-30 0.0, first perfect none, **stopped short**

![c51pilotB-lr25e4seed1](charts/c51pilotB-lr25e4seed1.png)
**c51pilotB-lr25e4seed1** — lr 0.00025, best-30 0.0, first perfect none, **stopped short**

![c51pilotB-lr25e4seed2](charts/c51pilotB-lr25e4seed2.png)
**c51pilotB-lr25e4seed2** — lr 0.00025, best-30 0.0, first perfect none, **stopped short**
