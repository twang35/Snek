...
#
#   cd snek2
#   nohup bash hyperparamTuning/launch_c51_batch.sh b31 > /tmp/c51-batch-handoff.log 2>&1 &
#
...
Written by hyperparamTuning/launch_c51_batch.sh with nobody watching, so the
