...
**~1,100 episodes/s across 8 shards** (the default is now 12 shards, expected ~25-40% faster and
not yet timed), so b4's 274 candidates (1.37M episodes) was ~25 min at 8
