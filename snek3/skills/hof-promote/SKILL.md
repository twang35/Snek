...
- **A desktop `hof30k` wave is this step done in bulk** — an eval spec with `"episodes": 30000`,
  `"eval_args": ["--label", "hof30k", "--seed", "7"]` and `above:99.2:hof5000` (99 before 2026-09-07), as b9's was. Same episodes, same seed, same eval path; its rows are confirmed rates and go straight
  to step 1.
