...
## Batch b14 — the `rollout` sweep, 2 values x 4 seeds, 50M

**In flight on the laptop: 8 of 8 arms trained, 0 running; 0 of 8 have their stage-B file** as of 2026-09-04 16:33. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.

| rollout | rows | ≥98%/500 | per-seed share | ≥99 (`hof5000` cands) | best row | best30 (mean, range) | sef | drawdown < 50% | < 80% | stage-A ≥98% |
|---|---:|---:|---|---:|---:|---|---:|---:|---:|---:|
| 32 | 0 | – | – – – – | 0 | – | 97.88 (97.5-98.1) | 78.8 | 0.22% | 17.14% | 8.9% |
| 64 | 0 | – | – – – – | 0 | – | 98.30 (98.1-98.7) | 88.7 | 0.18% | 6.59% | 18.6% |
...
## Batch b15 — the `entropy_coef` sweep, 2 values x 4 seeds, 50M (0 of 40 arms in)

**In flight: 0 of 40 arms trained, 8 running, 32 queued; stage B 0 wave(s) done; 5 training wave(s) left at ~2.5 h each -> ~2026-09-05 05:03** as of 2026-09-04 16:33. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.

| entropy_coef | rows | ≥98%/500 | per-seed share | ≥99 (`hof5000` cands) | best row | best30 (mean, range) | sef | drawdown < 50% | < 80% | stage-A ≥98% |
|---|---:|---:|---|---:|---:|---|---:|---:|---:|---:|
| 0.0 | 0 | – | – – – – | 0 | – | 97.60 (97.4-97.9) | 94.1 | 0.26% | 1.86% | 21.1% |
| 0.001 | 0 | – | – – – – | 0 | – | 97.90 (97.7-98.2) | 94.0 | 0.02% | 1.96% | 17.9% |
...
**Closed: all 32 arms trained on the laptop, stage B done for every wave** as of 2026-09-04 16:33. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
**Closed: all 40 arms trained, stage B done for every wave** as of 2026-09-04 16:33. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
**Closed: all 32 arms trained, stage B done for every wave** as of 2026-09-04 16:33. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
**Closed: all 64 arms trained, stage B done for every wave** as of 2026-09-04 16:33. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
