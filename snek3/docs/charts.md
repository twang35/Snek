...
## Batch b19 — the `knob` sweep, 2 values x 4 seeds, 50M

**In flight on the laptop: b19 | noadvnorm, mse | hof5000 (8 arms) | ~9m left** as of 2026-09-05 15:31. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
**knob base** — reference: b9 lambda 0.99 cell, all switches at the base: adv-norm on, huber, Adam eps 1e-7, vf 0.5:
...
**In flight: 24 of 64 arms trained, 0 running, 40 queued; stage B 3 wave(s) done; 5 training wave(s) left at ~2.4 h each -> ~2026-09-06 03:31** as of 2026-09-05 15:31. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
| **0.2** (reference) | 5,173 | 27.3% | 27.2 24.1 31.4 26.0 | 138 | 100.0 | 98.33 (98.3-98.4) | 90.6 | 0.77% | 6.43% | 28.9% |
...
| clip01anneal | 0 | – | – – – – | 0 | – | 44.75 (14.0-65.5) | 0.0 | – | – | 0.0% |
| lranneal | 0 | – | – – – – | 0 | – | 69.05 (63.6-72.3) | 1.2 | 0.0% | 40.0% | 0.0% |
...
**clip 0.2** — reference: b9 lambda 0.99 cell, clip 0.2, no anneal:
...
**Closed: all 40 arms trained on the laptop, stage B done for every wave** as of 2026-09-05 15:30. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.

| target_kl | rows | ≥98%/500 | per-seed share | ≥99 (`hof5000` cands) | best row | best30 (mean, range) | sef | drawdown < 50% | < 80% | stage-A ≥98% |
|---|---:|---:|---|---:|---:|---|---:|---:|---:|---:|
| **0** (reference) | 5,173 | 27.3% | 27.2 24.1 31.4 26.0 | 138 | 100.0 | 98.33 (98.3-98.4) | 90.6 | 0.77% | 6.43% | 28.9% |
...
**target_kl 0** — reference: b9 lambda 0.99 cell, target_KL off (0):
...
**Closed: all 24 arms trained on the laptop, stage B done for every wave** as of 2026-09-05 15:30. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
**Closed: all 40 arms trained, stage B done for every wave** as of 2026-09-05 15:30. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
**entropy_coef 0.01** — reference: b9 lambda 0.99 cell, entropy 0.01 fixed:
...
**Closed: all 32 arms trained on the laptop, stage B done for every wave** as of 2026-09-05 15:30. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
**Closed: all 32 arms trained, stage B done for every wave** as of 2026-09-05 15:30. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
**Closed: all 64 arms trained, stage B done for every wave** as of 2026-09-05 15:30. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
