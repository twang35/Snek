...
**In flight on the laptop: 8 of 16 arms trained, 8 running; 8 of 16 have their stage-B file** as of 2026-09-04 19:13. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
| 192 | 0 | – | – – – – | 0 | – | 97.80 (97.4-98.1) | 82.2 | 2.46% | 12.04% | 19.6% |
...
## Batch b15 — the `entropy_coef` sweep, 2 values x 4 seeds, 50M (8 of 40 arms in)

**In flight: 8 of 40 arms trained, 0 running, 32 queued; stage B 1 wave(s) done; 4 training wave(s) left at ~2.5 h each -> ~2026-09-05 05:13** as of 2026-09-04 19:13. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
**Closed: all 32 arms trained on the laptop, stage B done for every wave** as of 2026-09-04 19:13. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
**Closed: all 40 arms trained, stage B done for every wave** as of 2026-09-04 19:12. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
**Closed: all 32 arms trained, stage B done for every wave** as of 2026-09-04 19:12. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
**Closed: all 64 arms trained, stage B done for every wave** as of 2026-09-04 19:12. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
**Closed: all 64 arms trained, stage B done for every wave** as of 2026-09-04 19:11. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
