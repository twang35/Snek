...
**In flight: 8 of 32 arms trained, 0 running, 24 queued; stage B 0 wave(s) done; 3 training wave(s) left at ~2.5 h each -> ~2026-09-04 01:29** as of 2026-09-03 17:59. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
**Closed: all 64 arms trained, stage B done for every wave** as of 2026-09-03 17:59. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
