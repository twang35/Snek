...
## Batch b19 — the `knob` sweep, 4 values x 4 seeds, 50M

**In flight on the laptop: b19 | adameps1e5, adameps1e8 -- wave 2 of 3 | training (8 arms) | ~1.5h left** as of 2026-09-05 15:42. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
| adameps1e5 | 0 | – | – – – – | 0 | – | 84.65 (77.4-91.5) | 24.5 | 0.38% | 39.03% | 0.0% |
| adameps1e8 | 0 | – | – – – – | 0 | – | 85.00 (76.9-90.3) | 24.0 | 2.04% | 47.28% | 0.1% |
| **base** (reference) | 4,003 | 17.3% | 18.5 19.0 16.5 15.1 | 50 | 99.6 | 97.75 (97.7-97.8) | 90.9 | 0.29% | 6.18% | 20.4% |

<!-- reading -->
**Wave 1 (advantage normalisation off; mse value loss) closed with its hof5000 on the laptop; wave 2 (Adam ε 1e-5,
1e-8) is training, wave 3 (vf 0.1, 1.0) follows; the batch clears ~19:00 today with b20 and b21 behind it.** Read against the bold reference — **b7's λ 0.98 cell `b7aa`-`b7ad`, not b9's λ 0.99 arms**: b15-b21 were generated from b7's base (every arm's config table says `ppo_gae_lambda 0.98`, and the spec notes name `b7aa-b7ad` as the control), and until 2026-09-05 15:30 this table was read against the λ 0.99 cell, which made every cell look 8-14 pp short. The reference row is 17.3% density, best30 97.75, 6.2% of evals below 80%. A
switches batch, so each cell is named rather than valued. **mse is the row to look at**: 22.2% density against 17.3%
(three seeds at 21-28%, one at 14.6%), best30 98.35 against 97.75, and **0.97% of evals below 80% against 6.2%**, sef
96 — the best stability of any cell trained at this base, at higher density, where the spec predicted a noisier critic
and more collapses. noadvnorm is 12.9% (one seed at 5.2%) at 1.2% below 80%: stable, and 4 pp short on density. Both
switches were predicted to add collapses; both removed them. mse is a corner-grid candidate if its top holds at 30,000.
<!-- /reading -->

**knob noadvnorm** — `b19a`-`b19d`:

![b19a-noadvnorm-seed1](../runs/b19a-noadvnorm-seed1.png)
![b19a-noadvnorm-seed1 stage B](../runs/b19a-noadvnorm-seed1_checkpoint_evals.png)
![b19b-noadvnorm-seed2](../runs/b19b-noadvnorm-seed2.png)
![b19b-noadvnorm-seed2 stage B](../runs/b19b-noadvnorm-seed2_checkpoint_evals.png)
![b19c-noadvnorm-seed3](../runs/b19c-noadvnorm-seed3.png)
![b19c-noadvnorm-seed3 stage B](../runs/b19c-noadvnorm-seed3_checkpoint_evals.png)
![b19d-noadvnorm-seed4](../runs/b19d-noadvnorm-seed4.png)
![b19d-noadvnorm-seed4 stage B](../runs/b19d-noadvnorm-seed4_checkpoint_evals.png)

**knob mse** — `b19e`-`b19h`:

![b19e-mse-seed1](../runs/b19e-mse-seed1.png)
![b19e-mse-seed1 stage B](../runs/b19e-mse-seed1_checkpoint_evals.png)
![b19f-mse-seed2](../runs/b19f-mse-seed2.png)
![b19f-mse-seed2 stage B](../runs/b19f-mse-seed2_checkpoint_evals.png)
![b19g-mse-seed3](../runs/b19g-mse-seed3.png)
![b19g-mse-seed3 stage B](../runs/b19g-mse-seed3_checkpoint_evals.png)
![b19h-mse-seed4](../runs/b19h-mse-seed4.png)
![b19h-mse-seed4 stage B](../runs/b19h-mse-seed4_checkpoint_evals.png)

**knob adameps1e5** — `b19i`-`b19l`:

![b19i-adameps1e5-seed1](../runs/b19i-adameps1e5-seed1.png)
![b19j-adameps1e5-seed2](../runs/b19j-adameps1e5-seed2.png)
![b19k-adameps1e5-seed3](../runs/b19k-adameps1e5-seed3.png)
![b19l-adameps1e5-seed4](../runs/b19l-adameps1e5-seed4.png)

**knob adameps1e8** — `b19m`-`b19p`:

![b19m-adameps1e8-seed1](../runs/b19m-adameps1e8-seed1.png)
![b19n-adameps1e8-seed2](../runs/b19n-adameps1e8-seed2.png)
![b19o-adameps1e8-seed3](../runs/b19o-adameps1e8-seed3.png)
![b19p-adameps1e8-seed4](../runs/b19p-adameps1e8-seed4.png)
...
## Batch b17 — the `clip` sweep, 8 values x 4 seeds, 50M (24 of 64 arms in)

**In flight: 24 of 64 arms trained, 8 running, 32 queued; stage B 3 wave(s) done; 5 training wave(s) left at ~2.4 h each -> ~2026-09-06 03:42** as of 2026-09-05 15:42. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
| clip01anneal | 0 | – | – – – – | 0 | – | 90.75 (88.8-92.2) | 39.5 | 1.13% | 37.17% | 0.1% |
| lranneal | 0 | – | – – – – | 0 | – | 93.22 (91.7-94.4) | 53.5 | 2.12% | 27.46% | 1.2% |

<!-- reading -->
**Waves 1-3 (clip 0.05, 0.1, 0.15, 0.3, 0.4 and the 0.2→0.02 anneal) closed with their hof passes; wave 4 (the 0.1
anneal and the lr anneal) started training at 15:30 on the desktop; four anneal waves follow at ~2.4 h each, training
done ~03:40 2026-09-06.** Read against the bold reference — **b7's λ 0.98 cell `b7aa`-`b7ad`, not b9's λ 0.99 arms**: b15-b21 were generated from b7's base (every arm's config table says `ppo_gae_lambda 0.98`, and the spec notes name `b7aa-b7ad` as the control), and until 2026-09-05 15:30 this table was read against the λ 0.99 cell, which made every cell look 8-14 pp short. The reference row is 17.3% density, best30 97.75, 6.2% of evals below 80%. Density is flat around the base from 0.05 to 0.2 (17.4, 13.8, 18.6%) and falls past
it (14.9% at 0.3, 12.3% at 0.4); best30 is highest at the tight end (98.30 at 0.05, the batch's 100/500 row) and lowest
at the loose end (97.33 at 0.4). Stability improves as the clip loosens — 8.2% of evals below 80% at 0.05, then 6.6,
5.0, 6.2, 4.0, 4.5% up to 0.4 — the opposite of the spec's "looser: more collapses". The 0.2→0.02 anneal sits at the
base on density (16.7%) and above it on best30 (98.25, two of the batch's five best rows) and stability (4.3%): the
predicted steady endgame, at no density cost, at n=4. The remaining waves settle whether the anneals from 0.1 and the
lr anneal do the same, and whether any anneal beats the base rather than matching it.
<!-- /reading -->

**clip 0.05** — `b17aa`-`b17ad`:

![b17aa-clip005-seed1](../runs/b17aa-clip005-seed1.png)
![b17aa-clip005-seed1 stage B](../runs/b17aa-clip005-seed1_checkpoint_evals.png)
![b17ab-clip005-seed2](../runs/b17ab-clip005-seed2.png)
![b17ab-clip005-seed2 stage B](../runs/b17ab-clip005-seed2_checkpoint_evals.png)
![b17ac-clip005-seed3](../runs/b17ac-clip005-seed3.png)
![b17ac-clip005-seed3 stage B](../runs/b17ac-clip005-seed3_checkpoint_evals.png)
![b17ad-clip005-seed4](../runs/b17ad-clip005-seed4.png)
![b17ad-clip005-seed4 stage B](../runs/b17ad-clip005-seed4_checkpoint_evals.png)

**clip 0.1** — `b17ae`-`b17ah`:

![b17ae-clip01-seed1](../runs/b17ae-clip01-seed1.png)
![b17ae-clip01-seed1 stage B](../runs/b17ae-clip01-seed1_checkpoint_evals.png)
![b17af-clip01-seed2](../runs/b17af-clip01-seed2.png)
![b17af-clip01-seed2 stage B](../runs/b17af-clip01-seed2_checkpoint_evals.png)
![b17ag-clip01-seed3](../runs/b17ag-clip01-seed3.png)
![b17ag-clip01-seed3 stage B](../runs/b17ag-clip01-seed3_checkpoint_evals.png)
![b17ah-clip01-seed4](../runs/b17ah-clip01-seed4.png)
![b17ah-clip01-seed4 stage B](../runs/b17ah-clip01-seed4_checkpoint_evals.png)

**clip 0.15** — `b17ai`-`b17al`:

![b17ai-clip015-seed1](../runs/b17ai-clip015-seed1.png)
![b17ai-clip015-seed1 stage B](../runs/b17ai-clip015-seed1_checkpoint_evals.png)
![b17aj-clip015-seed2](../runs/b17aj-clip015-seed2.png)
![b17aj-clip015-seed2 stage B](../runs/b17aj-clip015-seed2_checkpoint_evals.png)
![b17ak-clip015-seed3](../runs/b17ak-clip015-seed3.png)
![b17ak-clip015-seed3 stage B](../runs/b17ak-clip015-seed3_checkpoint_evals.png)
![b17al-clip015-seed4](../runs/b17al-clip015-seed4.png)
![b17al-clip015-seed4 stage B](../runs/b17al-clip015-seed4_checkpoint_evals.png)
...
![b17am-clip03-seed1](../runs/b17am-clip03-seed1.png)
![b17am-clip03-seed1 stage B](../runs/b17am-clip03-seed1_checkpoint_evals.png)
![b17an-clip03-seed2](../runs/b17an-clip03-seed2.png)
![b17an-clip03-seed2 stage B](../runs/b17an-clip03-seed2_checkpoint_evals.png)
![b17ao-clip03-seed3](../runs/b17ao-clip03-seed3.png)
![b17ao-clip03-seed3 stage B](../runs/b17ao-clip03-seed3_checkpoint_evals.png)
![b17ap-clip03-seed4](../runs/b17ap-clip03-seed4.png)
![b17ap-clip03-seed4 stage B](../runs/b17ap-clip03-seed4_checkpoint_evals.png)

**clip 0.4** — `b17aq`-`b17at`:

![b17aq-clip04-seed1](../runs/b17aq-clip04-seed1.png)
![b17aq-clip04-seed1 stage B](../runs/b17aq-clip04-seed1_checkpoint_evals.png)
![b17ar-clip04-seed2](../runs/b17ar-clip04-seed2.png)
![b17ar-clip04-seed2 stage B](../runs/b17ar-clip04-seed2_checkpoint_evals.png)
![b17as-clip04-seed3](../runs/b17as-clip04-seed3.png)
![b17as-clip04-seed3 stage B](../runs/b17as-clip04-seed3_checkpoint_evals.png)
![b17at-clip04-seed4](../runs/b17at-clip04-seed4.png)
![b17at-clip04-seed4 stage B](../runs/b17at-clip04-seed4_checkpoint_evals.png)

**clip clipanneal** — `b17au`-`b17ax`:

![b17au-clipanneal-seed1](../runs/b17au-clipanneal-seed1.png)
![b17au-clipanneal-seed1 stage B](../runs/b17au-clipanneal-seed1_checkpoint_evals.png)
![b17av-clipanneal-seed2](../runs/b17av-clipanneal-seed2.png)
![b17av-clipanneal-seed2 stage B](../runs/b17av-clipanneal-seed2_checkpoint_evals.png)
![b17aw-clipanneal-seed3](../runs/b17aw-clipanneal-seed3.png)
![b17aw-clipanneal-seed3 stage B](../runs/b17aw-clipanneal-seed3_checkpoint_evals.png)
![b17ax-clipanneal-seed4](../runs/b17ax-clipanneal-seed4.png)
![b17ax-clipanneal-seed4 stage B](../runs/b17ax-clipanneal-seed4_checkpoint_evals.png)

**clip clip01anneal** — `b17ay`-`b17bb`:

![b17ay-clip01anneal-seed1](../runs/b17ay-clip01anneal-seed1.png)
![b17az-clip01anneal-seed2](../runs/b17az-clip01anneal-seed2.png)
![b17ba-clip01anneal-seed3](../runs/b17ba-clip01anneal-seed3.png)
![b17bb-clip01anneal-seed4](../runs/b17bb-clip01anneal-seed4.png)

**clip lranneal** — `b17bc`-`b17bf`:

![b17bc-lranneal-seed1](../runs/b17bc-lranneal-seed1.png)
![b17bd-lranneal-seed2](../runs/b17bd-lranneal-seed2.png)
![b17be-lranneal-seed3](../runs/b17be-lranneal-seed3.png)
![b17bf-lranneal-seed4](../runs/b17bf-lranneal-seed4.png)

<!-- /progress_update: batch b17 -->

<!-- progress_update: batch b16 -->
## Batch b16 — the `target_kl` sweep, 10 values x 4 seeds, 50M

**Closed: all 40 arms trained on the laptop, stage B done for every wave** as of 2026-09-05 15:41. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
**target_kl 0** — reference: b7 fc (320,) cell, lambda 0.98, target_KL off (0) -- the base b15-b21 were generated from:
...
**target_kl 0.003** — `b16aa`-`b16ad`:

![b16aa-kl003-seed1](../runs/b16aa-kl003-seed1.png)
![b16aa-kl003-seed1 stage B](../runs/b16aa-kl003-seed1_checkpoint_evals.png)
![b16ab-kl003-seed2](../runs/b16ab-kl003-seed2.png)
![b16ab-kl003-seed2 stage B](../runs/b16ab-kl003-seed2_checkpoint_evals.png)
![b16ac-kl003-seed3](../runs/b16ac-kl003-seed3.png)
![b16ac-kl003-seed3 stage B](../runs/b16ac-kl003-seed3_checkpoint_evals.png)
![b16ad-kl003-seed4](../runs/b16ad-kl003-seed4.png)
![b16ad-kl003-seed4 stage B](../runs/b16ad-kl003-seed4_checkpoint_evals.png)

**target_kl 0.005** — `b16ae`-`b16ah`:

![b16ae-kl005-seed1](../runs/b16ae-kl005-seed1.png)
![b16ae-kl005-seed1 stage B](../runs/b16ae-kl005-seed1_checkpoint_evals.png)
![b16af-kl005-seed2](../runs/b16af-kl005-seed2.png)
![b16af-kl005-seed2 stage B](../runs/b16af-kl005-seed2_checkpoint_evals.png)
![b16ag-kl005-seed3](../runs/b16ag-kl005-seed3.png)
![b16ag-kl005-seed3 stage B](../runs/b16ag-kl005-seed3_checkpoint_evals.png)
![b16ah-kl005-seed4](../runs/b16ah-kl005-seed4.png)
![b16ah-kl005-seed4 stage B](../runs/b16ah-kl005-seed4_checkpoint_evals.png)

**target_kl 0.008** — `b16ai`-`b16al`:

![b16ai-kl008-seed1](../runs/b16ai-kl008-seed1.png)
![b16ai-kl008-seed1 stage B](../runs/b16ai-kl008-seed1_checkpoint_evals.png)
![b16aj-kl008-seed2](../runs/b16aj-kl008-seed2.png)
![b16aj-kl008-seed2 stage B](../runs/b16aj-kl008-seed2_checkpoint_evals.png)
![b16ak-kl008-seed3](../runs/b16ak-kl008-seed3.png)
![b16ak-kl008-seed3 stage B](../runs/b16ak-kl008-seed3_checkpoint_evals.png)
![b16al-kl008-seed4](../runs/b16al-kl008-seed4.png)
![b16al-kl008-seed4 stage B](../runs/b16al-kl008-seed4_checkpoint_evals.png)

**target_kl 0.01** — `b16am`-`b16ap`:

![b16am-kl01-seed1](../runs/b16am-kl01-seed1.png)
![b16am-kl01-seed1 stage B](../runs/b16am-kl01-seed1_checkpoint_evals.png)
![b16an-kl01-seed2](../runs/b16an-kl01-seed2.png)
![b16an-kl01-seed2 stage B](../runs/b16an-kl01-seed2_checkpoint_evals.png)
![b16ao-kl01-seed3](../runs/b16ao-kl01-seed3.png)
![b16ao-kl01-seed3 stage B](../runs/b16ao-kl01-seed3_checkpoint_evals.png)
![b16ap-kl01-seed4](../runs/b16ap-kl01-seed4.png)
![b16ap-kl01-seed4 stage B](../runs/b16ap-kl01-seed4_checkpoint_evals.png)

**target_kl 0.013** — `b16aq`-`b16at`:

![b16aq-kl013-seed1](../runs/b16aq-kl013-seed1.png)
![b16aq-kl013-seed1 stage B](../runs/b16aq-kl013-seed1_checkpoint_evals.png)
![b16ar-kl013-seed2](../runs/b16ar-kl013-seed2.png)
![b16ar-kl013-seed2 stage B](../runs/b16ar-kl013-seed2_checkpoint_evals.png)
![b16as-kl013-seed3](../runs/b16as-kl013-seed3.png)
![b16as-kl013-seed3 stage B](../runs/b16as-kl013-seed3_checkpoint_evals.png)
![b16at-kl013-seed4](../runs/b16at-kl013-seed4.png)
![b16at-kl013-seed4 stage B](../runs/b16at-kl013-seed4_checkpoint_evals.png)

**target_kl 0.015** — `b16au`-`b16ax`:

![b16au-kl015-seed1](../runs/b16au-kl015-seed1.png)
![b16au-kl015-seed1 stage B](../runs/b16au-kl015-seed1_checkpoint_evals.png)
![b16av-kl015-seed2](../runs/b16av-kl015-seed2.png)
![b16av-kl015-seed2 stage B](../runs/b16av-kl015-seed2_checkpoint_evals.png)
![b16aw-kl015-seed3](../runs/b16aw-kl015-seed3.png)
![b16aw-kl015-seed3 stage B](../runs/b16aw-kl015-seed3_checkpoint_evals.png)
![b16ax-kl015-seed4](../runs/b16ax-kl015-seed4.png)
![b16ax-kl015-seed4 stage B](../runs/b16ax-kl015-seed4_checkpoint_evals.png)

**target_kl 0.02** — `b16ay`-`b16bb`:

![b16ay-kl02-seed1](../runs/b16ay-kl02-seed1.png)
![b16ay-kl02-seed1 stage B](../runs/b16ay-kl02-seed1_checkpoint_evals.png)
![b16az-kl02-seed2](../runs/b16az-kl02-seed2.png)
![b16az-kl02-seed2 stage B](../runs/b16az-kl02-seed2_checkpoint_evals.png)
![b16ba-kl02-seed3](../runs/b16ba-kl02-seed3.png)
![b16ba-kl02-seed3 stage B](../runs/b16ba-kl02-seed3_checkpoint_evals.png)
![b16bb-kl02-seed4](../runs/b16bb-kl02-seed4.png)
![b16bb-kl02-seed4 stage B](../runs/b16bb-kl02-seed4_checkpoint_evals.png)

**target_kl 0.03** — `b16bc`-`b16bf`:

![b16bc-kl03-seed1](../runs/b16bc-kl03-seed1.png)
![b16bc-kl03-seed1 stage B](../runs/b16bc-kl03-seed1_checkpoint_evals.png)
![b16bd-kl03-seed2](../runs/b16bd-kl03-seed2.png)
![b16bd-kl03-seed2 stage B](../runs/b16bd-kl03-seed2_checkpoint_evals.png)
![b16be-kl03-seed3](../runs/b16be-kl03-seed3.png)
![b16be-kl03-seed3 stage B](../runs/b16be-kl03-seed3_checkpoint_evals.png)
![b16bf-kl03-seed4](../runs/b16bf-kl03-seed4.png)
![b16bf-kl03-seed4 stage B](../runs/b16bf-kl03-seed4_checkpoint_evals.png)

**target_kl 0.04** — `b16bg`-`b16bj`:

![b16bg-kl04-seed1](../runs/b16bg-kl04-seed1.png)
![b16bg-kl04-seed1 stage B](../runs/b16bg-kl04-seed1_checkpoint_evals.png)
![b16bh-kl04-seed2](../runs/b16bh-kl04-seed2.png)
![b16bh-kl04-seed2 stage B](../runs/b16bh-kl04-seed2_checkpoint_evals.png)
![b16bi-kl04-seed3](../runs/b16bi-kl04-seed3.png)
![b16bi-kl04-seed3 stage B](../runs/b16bi-kl04-seed3_checkpoint_evals.png)
![b16bj-kl04-seed4](../runs/b16bj-kl04-seed4.png)
![b16bj-kl04-seed4 stage B](../runs/b16bj-kl04-seed4_checkpoint_evals.png)

**target_kl 0.05** — `b16bk`-`b16bn`:

![b16bk-kl05-seed1](../runs/b16bk-kl05-seed1.png)
![b16bk-kl05-seed1 stage B](../runs/b16bk-kl05-seed1_checkpoint_evals.png)
![b16bl-kl05-seed2](../runs/b16bl-kl05-seed2.png)
![b16bl-kl05-seed2 stage B](../runs/b16bl-kl05-seed2_checkpoint_evals.png)
![b16bm-kl05-seed3](../runs/b16bm-kl05-seed3.png)
![b16bm-kl05-seed3 stage B](../runs/b16bm-kl05-seed3_checkpoint_evals.png)
![b16bn-kl05-seed4](../runs/b16bn-kl05-seed4.png)
![b16bn-kl05-seed4 stage B](../runs/b16bn-kl05-seed4_checkpoint_evals.png)
...
**Closed: all 24 arms trained on the laptop, stage B done for every wave** as of 2026-09-05 15:41. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
![b14a-roll32-seed1](../runs/b14a-roll32-seed1.png)
![b14a-roll32-seed1 stage B](../runs/b14a-roll32-seed1_checkpoint_evals.png)
![b14b-roll32-seed2](../runs/b14b-roll32-seed2.png)
![b14b-roll32-seed2 stage B](../runs/b14b-roll32-seed2_checkpoint_evals.png)
![b14c-roll32-seed3](../runs/b14c-roll32-seed3.png)
![b14c-roll32-seed3 stage B](../runs/b14c-roll32-seed3_checkpoint_evals.png)
![b14d-roll32-seed4](../runs/b14d-roll32-seed4.png)
![b14d-roll32-seed4 stage B](../runs/b14d-roll32-seed4_checkpoint_evals.png)

**rollout 64** — `b14e`-`b14h`:

![b14e-roll64-seed1](../runs/b14e-roll64-seed1.png)
![b14e-roll64-seed1 stage B](../runs/b14e-roll64-seed1_checkpoint_evals.png)
![b14f-roll64-seed2](../runs/b14f-roll64-seed2.png)
![b14f-roll64-seed2 stage B](../runs/b14f-roll64-seed2_checkpoint_evals.png)
![b14g-roll64-seed3](../runs/b14g-roll64-seed3.png)
![b14g-roll64-seed3 stage B](../runs/b14g-roll64-seed3_checkpoint_evals.png)
![b14h-roll64-seed4](../runs/b14h-roll64-seed4.png)
![b14h-roll64-seed4 stage B](../runs/b14h-roll64-seed4_checkpoint_evals.png)
...
![b14i-roll192-seed1](../runs/b14i-roll192-seed1.png)
![b14i-roll192-seed1 stage B](../runs/b14i-roll192-seed1_checkpoint_evals.png)
![b14j-roll192-seed2](../runs/b14j-roll192-seed2.png)
![b14j-roll192-seed2 stage B](../runs/b14j-roll192-seed2_checkpoint_evals.png)
![b14k-roll192-seed3](../runs/b14k-roll192-seed3.png)
![b14k-roll192-seed3 stage B](../runs/b14k-roll192-seed3_checkpoint_evals.png)
![b14l-roll192-seed4](../runs/b14l-roll192-seed4.png)
![b14l-roll192-seed4 stage B](../runs/b14l-roll192-seed4_checkpoint_evals.png)

**rollout 256** — `b14m`-`b14p`:

![b14m-roll256-seed1](../runs/b14m-roll256-seed1.png)
![b14m-roll256-seed1 stage B](../runs/b14m-roll256-seed1_checkpoint_evals.png)
![b14n-roll256-seed2](../runs/b14n-roll256-seed2.png)
![b14n-roll256-seed2 stage B](../runs/b14n-roll256-seed2_checkpoint_evals.png)
![b14o-roll256-seed3](../runs/b14o-roll256-seed3.png)
![b14o-roll256-seed3 stage B](../runs/b14o-roll256-seed3_checkpoint_evals.png)
![b14p-roll256-seed4](../runs/b14p-roll256-seed4.png)
![b14p-roll256-seed4 stage B](../runs/b14p-roll256-seed4_checkpoint_evals.png)

**rollout 512** — `b14q`-`b14t`:

![b14q-roll512-seed1](../runs/b14q-roll512-seed1.png)
![b14q-roll512-seed1 stage B](../runs/b14q-roll512-seed1_checkpoint_evals.png)
![b14r-roll512-seed2](../runs/b14r-roll512-seed2.png)
![b14r-roll512-seed2 stage B](../runs/b14r-roll512-seed2_checkpoint_evals.png)
![b14s-roll512-seed3](../runs/b14s-roll512-seed3.png)
![b14s-roll512-seed3 stage B](../runs/b14s-roll512-seed3_checkpoint_evals.png)
![b14t-roll512-seed4](../runs/b14t-roll512-seed4.png)
![b14t-roll512-seed4 stage B](../runs/b14t-roll512-seed4_checkpoint_evals.png)

**rollout 1024** — `b14u`-`b14x`:

![b14u-roll1024-seed1](../runs/b14u-roll1024-seed1.png)
![b14u-roll1024-seed1 stage B](../runs/b14u-roll1024-seed1_checkpoint_evals.png)
![b14v-roll1024-seed2](../runs/b14v-roll1024-seed2.png)
![b14v-roll1024-seed2 stage B](../runs/b14v-roll1024-seed2_checkpoint_evals.png)
![b14w-roll1024-seed3](../runs/b14w-roll1024-seed3.png)
![b14w-roll1024-seed3 stage B](../runs/b14w-roll1024-seed3_checkpoint_evals.png)
![b14x-roll1024-seed4](../runs/b14x-roll1024-seed4.png)
![b14x-roll1024-seed4 stage B](../runs/b14x-roll1024-seed4_checkpoint_evals.png)

<!-- /progress_update: batch b14 -->

<!-- progress_update: batch b15 -->
## Batch b15 — the `entropy_coef` sweep, 10 values x 4 seeds, 50M

**Closed: all 40 arms trained, stage B done for every wave** as of 2026-09-05 15:41. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
![b15aa-ent0-seed1](../runs/b15aa-ent0-seed1.png)
![b15aa-ent0-seed1 stage B](../runs/b15aa-ent0-seed1_checkpoint_evals.png)
![b15ab-ent0-seed2](../runs/b15ab-ent0-seed2.png)
![b15ab-ent0-seed2 stage B](../runs/b15ab-ent0-seed2_checkpoint_evals.png)
![b15ac-ent0-seed3](../runs/b15ac-ent0-seed3.png)
![b15ac-ent0-seed3 stage B](../runs/b15ac-ent0-seed3_checkpoint_evals.png)
![b15ad-ent0-seed4](../runs/b15ad-ent0-seed4.png)
![b15ad-ent0-seed4 stage B](../runs/b15ad-ent0-seed4_checkpoint_evals.png)

**entropy_coef 0.001** — `b15ae`-`b15ah`:

![b15ae-ent001-seed1](../runs/b15ae-ent001-seed1.png)
![b15ae-ent001-seed1 stage B](../runs/b15ae-ent001-seed1_checkpoint_evals.png)
![b15af-ent001-seed2](../runs/b15af-ent001-seed2.png)
![b15af-ent001-seed2 stage B](../runs/b15af-ent001-seed2_checkpoint_evals.png)
![b15ag-ent001-seed3](../runs/b15ag-ent001-seed3.png)
![b15ag-ent001-seed3 stage B](../runs/b15ag-ent001-seed3_checkpoint_evals.png)
![b15ah-ent001-seed4](../runs/b15ah-ent001-seed4.png)
![b15ah-ent001-seed4 stage B](../runs/b15ah-ent001-seed4_checkpoint_evals.png)

**entropy_coef 0.003** — `b15ai`-`b15al`:

![b15ai-ent003-seed1](../runs/b15ai-ent003-seed1.png)
![b15ai-ent003-seed1 stage B](../runs/b15ai-ent003-seed1_checkpoint_evals.png)
![b15aj-ent003-seed2](../runs/b15aj-ent003-seed2.png)
![b15aj-ent003-seed2 stage B](../runs/b15aj-ent003-seed2_checkpoint_evals.png)
![b15ak-ent003-seed3](../runs/b15ak-ent003-seed3.png)
![b15ak-ent003-seed3 stage B](../runs/b15ak-ent003-seed3_checkpoint_evals.png)
![b15al-ent003-seed4](../runs/b15al-ent003-seed4.png)
![b15al-ent003-seed4 stage B](../runs/b15al-ent003-seed4_checkpoint_evals.png)

**entropy_coef 0.005** — `b15am`-`b15ap`:

![b15am-ent005-seed1](../runs/b15am-ent005-seed1.png)
![b15am-ent005-seed1 stage B](../runs/b15am-ent005-seed1_checkpoint_evals.png)
![b15an-ent005-seed2](../runs/b15an-ent005-seed2.png)
![b15an-ent005-seed2 stage B](../runs/b15an-ent005-seed2_checkpoint_evals.png)
![b15ao-ent005-seed3](../runs/b15ao-ent005-seed3.png)
![b15ao-ent005-seed3 stage B](../runs/b15ao-ent005-seed3_checkpoint_evals.png)
![b15ap-ent005-seed4](../runs/b15ap-ent005-seed4.png)
![b15ap-ent005-seed4 stage B](../runs/b15ap-ent005-seed4_checkpoint_evals.png)

**entropy_coef 0.01** — reference: b7 fc (320,) cell, lambda 0.98, entropy 0.01 fixed -- the base b15-b21 were generated from:
...
**entropy_coef 0.02** — `b15aq`-`b15at`:

![b15aq-ent02-seed1](../runs/b15aq-ent02-seed1.png)
![b15aq-ent02-seed1 stage B](../runs/b15aq-ent02-seed1_checkpoint_evals.png)
![b15ar-ent02-seed2](../runs/b15ar-ent02-seed2.png)
![b15ar-ent02-seed2 stage B](../runs/b15ar-ent02-seed2_checkpoint_evals.png)
![b15as-ent02-seed3](../runs/b15as-ent02-seed3.png)
![b15as-ent02-seed3 stage B](../runs/b15as-ent02-seed3_checkpoint_evals.png)
![b15at-ent02-seed4](../runs/b15at-ent02-seed4.png)
![b15at-ent02-seed4 stage B](../runs/b15at-ent02-seed4_checkpoint_evals.png)

**entropy_coef 0.03** — `b15au`-`b15ax`:

![b15au-ent03-seed1](../runs/b15au-ent03-seed1.png)
![b15au-ent03-seed1 stage B](../runs/b15au-ent03-seed1_checkpoint_evals.png)
![b15av-ent03-seed2](../runs/b15av-ent03-seed2.png)
![b15av-ent03-seed2 stage B](../runs/b15av-ent03-seed2_checkpoint_evals.png)
![b15aw-ent03-seed3](../runs/b15aw-ent03-seed3.png)
![b15aw-ent03-seed3 stage B](../runs/b15aw-ent03-seed3_checkpoint_evals.png)
![b15ax-ent03-seed4](../runs/b15ax-ent03-seed4.png)
![b15ax-ent03-seed4 stage B](../runs/b15ax-ent03-seed4_checkpoint_evals.png)

**entropy_coef entanneal10** — `b15ay`-`b15bb`:

![b15ay-entanneal10-seed1](../runs/b15ay-entanneal10-seed1.png)
![b15ay-entanneal10-seed1 stage B](../runs/b15ay-entanneal10-seed1_checkpoint_evals.png)
![b15az-entanneal10-seed2](../runs/b15az-entanneal10-seed2.png)
![b15az-entanneal10-seed2 stage B](../runs/b15az-entanneal10-seed2_checkpoint_evals.png)
![b15ba-entanneal10-seed3](../runs/b15ba-entanneal10-seed3.png)
![b15ba-entanneal10-seed3 stage B](../runs/b15ba-entanneal10-seed3_checkpoint_evals.png)
![b15bb-entanneal10-seed4](../runs/b15bb-entanneal10-seed4.png)
![b15bb-entanneal10-seed4 stage B](../runs/b15bb-entanneal10-seed4_checkpoint_evals.png)

**entropy_coef entanneal03** — `b15bc`-`b15bf`:

![b15bc-entanneal03-seed1](../runs/b15bc-entanneal03-seed1.png)
![b15bc-entanneal03-seed1 stage B](../runs/b15bc-entanneal03-seed1_checkpoint_evals.png)
![b15bd-entanneal03-seed2](../runs/b15bd-entanneal03-seed2.png)
![b15bd-entanneal03-seed2 stage B](../runs/b15bd-entanneal03-seed2_checkpoint_evals.png)
![b15be-entanneal03-seed3](../runs/b15be-entanneal03-seed3.png)
![b15be-entanneal03-seed3 stage B](../runs/b15be-entanneal03-seed3_checkpoint_evals.png)
![b15bf-entanneal03-seed4](../runs/b15bf-entanneal03-seed4.png)
![b15bf-entanneal03-seed4 stage B](../runs/b15bf-entanneal03-seed4_checkpoint_evals.png)

**entropy_coef entanneal01** — `b15bg`-`b15bj`:

![b15bg-entanneal01-seed1](../runs/b15bg-entanneal01-seed1.png)
![b15bg-entanneal01-seed1 stage B](../runs/b15bg-entanneal01-seed1_checkpoint_evals.png)
![b15bh-entanneal01-seed2](../runs/b15bh-entanneal01-seed2.png)
![b15bh-entanneal01-seed2 stage B](../runs/b15bh-entanneal01-seed2_checkpoint_evals.png)
![b15bi-entanneal01-seed3](../runs/b15bi-entanneal01-seed3.png)
![b15bi-entanneal01-seed3 stage B](../runs/b15bi-entanneal01-seed3_checkpoint_evals.png)
![b15bj-entanneal01-seed4](../runs/b15bj-entanneal01-seed4.png)
![b15bj-entanneal01-seed4 stage B](../runs/b15bj-entanneal01-seed4_checkpoint_evals.png)

**entropy_coef entanneal01to0** — `b15bk`-`b15bn`:

![b15bk-entanneal01to0-seed1](../runs/b15bk-entanneal01to0-seed1.png)
![b15bk-entanneal01to0-seed1 stage B](../runs/b15bk-entanneal01to0-seed1_checkpoint_evals.png)
![b15bl-entanneal01to0-seed2](../runs/b15bl-entanneal01to0-seed2.png)
![b15bl-entanneal01to0-seed2 stage B](../runs/b15bl-entanneal01to0-seed2_checkpoint_evals.png)
![b15bm-entanneal01to0-seed3](../runs/b15bm-entanneal01to0-seed3.png)
![b15bm-entanneal01to0-seed3 stage B](../runs/b15bm-entanneal01to0-seed3_checkpoint_evals.png)
![b15bn-entanneal01to0-seed4](../runs/b15bn-entanneal01to0-seed4.png)
![b15bn-entanneal01to0-seed4 stage B](../runs/b15bn-entanneal01to0-seed4_checkpoint_evals.png)
...
**Closed: all 32 arms trained on the laptop, stage B done for every wave** as of 2026-09-05 15:40. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
![b13bb-mb1024-seed4 stage B](../runs/b13bb-mb1024-seed4_checkpoint_evals.png)

**minibatch 2048** — `b13bc`-`b13bf`:

![b13bc-mb2048-seed1](../runs/b13bc-mb2048-seed1.png)
![b13bc-mb2048-seed1 stage B](../runs/b13bc-mb2048-seed1_checkpoint_evals.png)
![b13bd-mb2048-seed2](../runs/b13bd-mb2048-seed2.png)
![b13bd-mb2048-seed2 stage B](../runs/b13bd-mb2048-seed2_checkpoint_evals.png)
![b13be-mb2048-seed3](../runs/b13be-mb2048-seed3.png)
![b13be-mb2048-seed3 stage B](../runs/b13be-mb2048-seed3_checkpoint_evals.png)
![b13bf-mb2048-seed4](../runs/b13bf-mb2048-seed4.png)
![b13bf-mb2048-seed4 stage B](../runs/b13bf-mb2048-seed4_checkpoint_evals.png)

<!-- /progress_update: batch b13 -->

<!-- progress_update: batch b12 -->
## Batch b12 — the `epochs` sweep, 10 values x 4 seeds, 50M

**Closed: all 40 arms trained, stage B done for every wave** as of 2026-09-05 15:40. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
![b12av-ep7-seed2 stage B](../runs/b12av-ep7-seed2_checkpoint_evals.png)
![b12aw-ep7-seed3](../runs/b12aw-ep7-seed3.png)
![b12aw-ep7-seed3 stage B](../runs/b12aw-ep7-seed3_checkpoint_evals.png)
![b12ax-ep7-seed4](../runs/b12ax-ep7-seed4.png)
![b12ax-ep7-seed4 stage B](../runs/b12ax-ep7-seed4_checkpoint_evals.png)

**epochs 8** — `b12ay`-`b12bb`:

![b12ay-ep8-seed1](../runs/b12ay-ep8-seed1.png)
![b12ay-ep8-seed1 stage B](../runs/b12ay-ep8-seed1_checkpoint_evals.png)
![b12az-ep8-seed2](../runs/b12az-ep8-seed2.png)
![b12az-ep8-seed2 stage B](../runs/b12az-ep8-seed2_checkpoint_evals.png)
![b12ba-ep8-seed3](../runs/b12ba-ep8-seed3.png)
![b12ba-ep8-seed3 stage B](../runs/b12ba-ep8-seed3_checkpoint_evals.png)
![b12bb-ep8-seed4](../runs/b12bb-ep8-seed4.png)
![b12bb-ep8-seed4 stage B](../runs/b12bb-ep8-seed4_checkpoint_evals.png)

**epochs 10** — `b12bc`-`b12bf`:

![b12bc-ep10-seed1](../runs/b12bc-ep10-seed1.png)
![b12bc-ep10-seed1 stage B](../runs/b12bc-ep10-seed1_checkpoint_evals.png)
![b12bd-ep10-seed2](../runs/b12bd-ep10-seed2.png)
![b12bd-ep10-seed2 stage B](../runs/b12bd-ep10-seed2_checkpoint_evals.png)
![b12be-ep10-seed3](../runs/b12be-ep10-seed3.png)
![b12be-ep10-seed3 stage B](../runs/b12be-ep10-seed3_checkpoint_evals.png)
![b12bf-ep10-seed4](../runs/b12bf-ep10-seed4.png)
![b12bf-ep10-seed4 stage B](../runs/b12bf-ep10-seed4_checkpoint_evals.png)

**epochs 12** — `b12bg`-`b12bj`:

![b12bg-ep12-seed1](../runs/b12bg-ep12-seed1.png)
![b12bg-ep12-seed1 stage B](../runs/b12bg-ep12-seed1_checkpoint_evals.png)
![b12bh-ep12-seed2](../runs/b12bh-ep12-seed2.png)
![b12bh-ep12-seed2 stage B](../runs/b12bh-ep12-seed2_checkpoint_evals.png)
![b12bi-ep12-seed3](../runs/b12bi-ep12-seed3.png)
![b12bi-ep12-seed3 stage B](../runs/b12bi-ep12-seed3_checkpoint_evals.png)
![b12bj-ep12-seed4](../runs/b12bj-ep12-seed4.png)
![b12bj-ep12-seed4 stage B](../runs/b12bj-ep12-seed4_checkpoint_evals.png)

**epochs 16** — `b12bk`-`b12bn`:

![b12bk-ep16-seed1](../runs/b12bk-ep16-seed1.png)
![b12bk-ep16-seed1 stage B](../runs/b12bk-ep16-seed1_checkpoint_evals.png)
![b12bl-ep16-seed2](../runs/b12bl-ep16-seed2.png)
![b12bl-ep16-seed2 stage B](../runs/b12bl-ep16-seed2_checkpoint_evals.png)
![b12bm-ep16-seed3](../runs/b12bm-ep16-seed3.png)
![b12bm-ep16-seed3 stage B](../runs/b12bm-ep16-seed3_checkpoint_evals.png)
![b12bn-ep16-seed4](../runs/b12bn-ep16-seed4.png)
![b12bn-ep16-seed4 stage B](../runs/b12bn-ep16-seed4_checkpoint_evals.png)
...
**Closed: all 32 arms trained, stage B done for every wave** as of 2026-09-05 15:40. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
**Closed: all 64 arms trained, stage B done for every wave** as of 2026-09-05 15:40. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
...
**Closed: all 64 arms trained, stage B done for every wave** as of 2026-09-05 15:39. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.
