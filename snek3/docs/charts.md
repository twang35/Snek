...
## Batch b11 — the `learning_rate` sweep, 2 values x 4 seeds, 50M

**Desktop state not read (--no-sync)** as of 2026-09-03 18:12. Reference group marked. Regenerated by `tools/progress_update.py`; only the reading block is hand-written.

| learning_rate | rows | ≥98%/500 | per-seed share | ≥99 (`hof5000` cands) | best row | best30 (mean, range) | sef | drawdown < 50% | < 80% | stage-A ≥98% |
|---|---:|---:|---|---:|---:|---|---:|---:|---:|---:|
| 4e-5 | 0 | – | – – – – | 0 | – | 97.17 (97.0-97.6) | 73.4 | – | – | – |
| 1e-4 | 0 | – | – – – – | 0 | – | 98.17 (97.8-98.6) | 85.1 | – | – | – |
