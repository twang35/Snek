...
| knobs | `SNEK_GDI_*`: the family and its grid, the selector and its bandit count, V-trace's ρ̄ and c̄, the three loss scalings, the optimiser's warm-up and anneal. Defaults are GDI's Table 5 values above. PPO's and DQN's knobs refused by name |
