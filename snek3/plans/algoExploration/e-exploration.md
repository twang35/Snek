...
| mixtures | 32; β_max 0.3; γ 0.997 → 0.99 | 32; γ 0.9999 → 0.99 with the three-piece spacing of App. G.1 | **the paper's, per row**: E1 γ 0.997 → 0.99 with NGU's spacing; E2 γ 0.9999 → 0.99 with the three-piece spacing. The exploitative index acts at the top of the ladder, so E1 is measured at 0.997 and E2 at 0.9999; a 2,300-move game at 0.9999 is effectively undiscounted, which is what the paper's exploitative arm is too |
