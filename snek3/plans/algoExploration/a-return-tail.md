...
| A6 | **waiting** on the user's call (2026-09-19): b38's reading is in, so M-best goes on QR-DQN or C51, not IQN; gate 3 passed (the three Munchausen mutants in `mut_dist.json`), gates 1 and 5 see §4 | -- (M-DQN on b35's local cell, M-best on b37's QR-DQN N 32 or C51) | 4 paper M-DQN (on A1 paper) + 4 paper M-best (on the best of A2-A5's paper cells) | A1; that rung | A1 paper; that rung | as A1 |
